...
<div class="bookmark-list-item group bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors {$selectedBookmarks.has(bookmark.id) ? 'selected' : ''} {bookmark.isAlive === false ? 'bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-900/40' : ''}">
    ...
    <div class="flex-1 min-w-0 cursor-pointer" 
      ...
      <div class="flex items-center justify-between gap-2">
        ...
        <div class="flex-1 min-w-0 flex flex-col">
          ...
          <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400 mt-0.5">
            ...
            {#if bookmark.readingTime}
              ...
              <span class="text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-700 px-1.5 py-0.5 rounded" title="Estimated reading time">
        ...
        <div class="flex items-center gap-3 flex-shrink-0">
          <span class="text-xs text-gray-400 dark:text-gray-500 whitespace-nowrap hidden sm:block">
          ...
          <div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
            <button
              ...
              class="p-1 text-gray-400 dark:text-gray-500 hover:text-purple-600 dark:hover:text-purple-400"
...
<style>
  ...
  :global(.dark) .bookmark-list-item.selected {
